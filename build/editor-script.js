...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"ud/teaser-card-in-cover","title":"Teaser-Card in Cover","description":"Zeigt den Titel eines ausgewählten Beitrags/Projekts und einen Mehr-Link mit Wellen-Overlay.","category":"design","icon":"clipboard","keywords":["teaser","cover","link"],"textdomain":"ud-teaser-card-in-cover","supports":{"html":false,"anchor":true},"attributes":{"postId":{"type":"number","default":0}},"editorScript":"file:./build/editor-script.js","style":"file:./build/frontend-style.css","editorStyle":"file:./build/editor-style.css","render":"file:./includes/render.php"}');
...
function Edit({
  ...
  const posts = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.useSelect)(select => {
    ...
    const projekte = core.getEntityRecords("postType", "projekt", query) || [];
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    setOptions(posts.map(p => ({
      label: p.title?.rendered || (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("(kein Titel)", "ud-teaser-card-in-cover"),
      value: String(p.id)
    })));
  }, [posts]);
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ComboboxControl, {
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Beitrag wählen", "ud-teaser-card-in-cover"),
      value: postId ? String(postId) : "",
      onChange: val => setAttributes({
        postId: parseInt(val, 10) || 0
      }),
      options: options
    })
  });
